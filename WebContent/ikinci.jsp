...
<div class="clear"></div>
	...
	<%
	String s1= (String) request.getAttribute("hastalik");
	String s2= (String) request.getAttribute("aciklama");

	%>
	<%
	out.write("hastalik adi:"+s1+"<br>");
	out.write("hastalik aciklamasi:"+s2);
...
<a href="Disease?hastalik=<%=s1 %>">Gen Bilgileri</a>
