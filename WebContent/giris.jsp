...
<link rel="stylesheet" type="text/css" href="C:\tez_proje\stil.css" media="screen" />

<script type="text/javascript" src="http://efesezginlab.iyte.edu.tr/wp-includes/js/jquery/jquery.js?ver=1.8.3"></script>
...
<link rel="stylesheet" type="text/css" href="C:\tez_proje\stil2.css" media="screen" />
...
<ul> <li><a href="DiseaseTest?value=OBEZITE">OBEZITE</a></li> <li><a href="DiseaseTest?value=METABOLIK SENDROM">METABOLIK SENDROM</a></li>  </ul>
</li>
...
<section class="container">
    <div class="login">
      <h1>Login to Nutrigenomic Web Portal</h1>
...
nutrigenom ile ilgili bilgiler
